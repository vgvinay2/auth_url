...
class ShortUrlsControllerTest < ActionController::TestCase
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post :create, short_url: { original_url: @short_url.original_url, short_url: @short_url.short_url, user_id: @short_url.user_id, visits_count: @short_url.visits_count }
    end
  ...
  test "should update short_url" do
    patch :update, id: @short_url, short_url: { original_url: @short_url.original_url, short_url: @short_url.short_url, user_id: @short_url.user_id, visits_count: @short_url.visits_count }
    assert_redirected_to short_url_path(assigns(:short_url))
  end
